    ...
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
          ...
          {/* Main App Container */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl md:rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            {/* Scenario & Persona Section */}
            <div className="bg-gradient-to-r from-orange-50 to-pink-50 p-4 sm:p-6 md:p-8 border-b border-white/20">
        ...
        <div id="about" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 text-center">About BugTrail</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">How it Works</h3>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5 flex-shrink-0">1</span>
                    Choose a realistic support scenario
                  </li>
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5 flex-shrink-0">2</span>
                    Chat with the AI customer who reveals facts gradually
                  </li>
                  <li className="flex items-start">
                    <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-sm font-semibold mr-3 mt-0.5 flex-shrink-0">3</span>
