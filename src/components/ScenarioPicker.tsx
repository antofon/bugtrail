      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {scenarioBriefs.map((scenario) => (
          <button
            ...
            className={`p-3 sm:p-4 rounded-xl text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 min-h-[60px] flex items-center justify-center text-center ${
